...
const sortedTestArray = [361, 437, 494, 517, 826, 853, 1088, 1229, 1362, 1484,
...
for (let algorithm of algorithms) {
  describe(`${algorithm.name}`, () => {
    ...
    it ('sorts array of one', () => {
      expect(algorithm([7])).toEqual([7])
    })

    it ('sorts array of two', () => {
      expect(algorithm([7, 5])).toEqual([5, 7])
    })

    it ('sorts repeating numbers', () => {
      expect(algorithm([7, 7, 5, 5])).toEqual([5, 5, 7, 7])
    })

    it('sorts a large array', () => {
      expect(algorithm(unsortedTestArray)).toEqual(sortedTestArray)
    })
  })
}
